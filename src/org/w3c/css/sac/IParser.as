package org.w3c.css.sac
{
	...
	public interface IParser
	{
		 ...
		 * 
		 */
		function set conditionFactory( factory:IConditionFactory ):void;
		 ...
		 * @see ICSSException
		 */
		function set errorHandler( handler:IErrorHandler ):void
		 ...
		 * 
		 */
		function set selectorFactory( factory:ISelectorFactory ):void;
	}
}